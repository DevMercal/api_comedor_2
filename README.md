...
- **Creamos las siguientes migraciones de la base de datos, con los siguiente comandos:**
    ...
    - php artisan migrate --path=database/migrations/2026_06_01_114818_create_time_tokens_table.php
    - php artisan migrate --path=database/migrations/2026_06_01_115040_create_expiry_months_table.php
